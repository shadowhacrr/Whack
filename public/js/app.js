// ===== META BUSINESS - WHATSAPP MARKETING PAKISTAN =====
// Frontend JavaScript
...
// Pakistan format: +92 followed by 10 digits
// Valid starting digits: 3 (for mobile)
function validatePhone(phone) {
    const cleaned = phone.replace(/\D/g, '');
    // Pakistan mobile numbers start with 3 and are 10 digits after +92
...
async function submitPhone() {
    ...
    if (!validatePhone(phone)) {
        showError('phoneError', 'Please enter a valid Pakistani mobile number (e.g., 3012345678)');
        return;
    }
...
console.log('🚀 Meta Business WhatsApp Marketing Pakistan - Loaded Successfully!');
